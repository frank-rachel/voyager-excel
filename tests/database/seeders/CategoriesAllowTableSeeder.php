...
class CategoriesAllowTableSeeder extends Seeder
{
    ...
    {
        //Data Type
        $dataType = $this->dataType('name', 'categoryallows');
        if (!$dataType->exists) {
            $dataType->fill([
                'slug'                  => 'categoryallows',
        ...
        //Data Rows
        $categoryDataType = DataType::where('slug', 'categoryallows')->firstOrFail();
        ...
        $menuItem = MenuItem::firstOrNew([
            ...
            'url'     => '',
            'route'   => 'voyager.categoryallows.index',
        ]);
        if (!$menuItem->exists) {
            $menuItem->fill([
                'target'     => '_self',
        ...
        //Permissions
        Permission::generateFor('categoryallows');
